...
class DepositController extends Controller
{
    ...
    {
        $pageTitle = 'Pending Tour Payments';
    ...
    {
        $pageTitle = 'Approved Tour Payments';
    ...
    {
        $pageTitle = 'Successful Tour Payments';
    ...
    {
        $pageTitle = 'Rejected Tour Payments';
    ...
    {
        $pageTitle = 'Initiated Tour Payments';
    ...
    {
        $pageTitle = 'Tour Payments History';
    ...
    public function details($id)
    {
        ...
        $pageTitle = 'Payment Request of ' . showAmount($deposit->amount) . ' '.$general->cur_text;
