...
@section('panel')
@include('admin.components.tabs.agency')
<div class="row">
    <div class="col-lg-12">
                ...
                <div class="table-responsive--md  table-responsive">
                    <table class="table table--light style--two">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="{{ route('admin.agencies.detail', $user->id) }}">{{$user->fullname}}
                                        ({{$user->username}})</a>
                                </td>
                                <td>
                                    {{ $user->email }}
                                ...
                                <td>
                                    @if (Request::routeIs('admin.agencies.kyc.pending'))
                                    <a title="@lang('Kyc Details')"
                                        href="{{ route('admin.agencies.kyc.details', $user->id) }}"
                                        class="btn btn-sm btn--primary">
                                        <i class="las la-info-circle text--shadow"></i>
                                    </a>
                                @endif
                                    <a title="@lang('User Profile')" href="{{ route('admin.agencies.detail', $user->id) }}"
                                        class="btn btn-sm btn--primary">
