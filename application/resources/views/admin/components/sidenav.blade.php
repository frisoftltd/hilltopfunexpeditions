    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.agencies.*') }}">
                    <a href="{{ route('admin.agencies.active') }}" class="nav-link position-relative">
                        <i class="menu-icon las la-user"></i>
                        <span class="menu-title">@lang('All Agencies')</span>
                        @if ($agencyBannedUsersCount > 0 || $agencyEmailUnverifiedUsersCount > 0 || $agencyMobileUnverifiedUsersCount > 0)
                            <div class="blob white"></div>
                        @endif
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item  {{ menuActive('admin.tour.package.booking.*') }}">
                    <a href="{{ route('admin.tour.package.booking.index') }}" class="nav-link"
                        data-default-url="{{ route('admin.tour.package.booking.index') }}">
                        <i class="menu-icon las la-box"></i>
                        <span class="menu-title">@lang('Tour & Bookings')</span>
                    </a>
                </li>
                <li class="sidebar__menu-header">@lang('Tour Package Management')</li>
                ...
                <li class="sidebar-menu-item  {{ menuActive('admin.tour.package.index*') }}">
                    <a href="{{ route('admin.tour.package.index') }}" class="nav-link"
                        ...
                        <i class=" menu-icon las la-plane"></i>
                        <span class="menu-title">@lang('Tour Package') </span>
                ...
                <li
                    class="sidebar-menu-item {{ menuActive(['admin.report.login.history','admin.agency.report.login.history', 'admin.report.login.ipHistory','admin.agency.report.login.ipHistory']) }}">
                    <a href="{{ route('admin.report.login.history') }}" class="nav-link">
                        <i class="menu-icon las la-sign-in-alt"></i>
                        <span class="menu-title">@lang('Login Activities')</span>
                    </a>
                </li>
                <li class="sidebar-menu-item {{ menuActive(['admin.report.notification.history','admin.agency.report.notification.history']) }}">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.agency.ticket.*') }}">
                    <a href="{{ route('admin.agency.ticket.pending') }}" class="nav-link position-relative">
                        <i class="menu-icon las la la-life-ring"></i>
                        <span class="menu-title">@lang('Agency Tickets')</span>
                        @if (0 < $agencyPendingTicketCount)
                            <div class="blob white">
                            </div>
                        @endif
                    </a>
                ...
                <li class="sidebar-menu-item {{ menuActive(['admin.agency.kyc.setting']) }}">
                    <a href="{{ route('admin.agency.kyc.setting') }}" class="nav-link">
                        <i class="menu-icon las la-credit-card"></i>
                        <span class="menu-title">@lang('Agency KYC')</span>
                    </a>
                </li>
