            ...
            <div class="card-body">
                <div class="row gy">
                    ...
                    <form action="{{ route('admin.location.update',$location->id) }}" method="post"
                        ...
                        <div class="row">
                            <span class="badge text-dark bg-warning d-none mb-2" id="authfail">@lang('Google Maps API
                                authentication failed! Please check your API key. Please Go to global settings and set
                                Maps API key.')</span>
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-sm-4">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="location" id="locationInput"
                                                        class="controls form-control" value="{{$location->location}}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="status" id="status" class="form-control" required>
                                                        ...
                                                        <option value="1" {{$location->status == 1 ? 'selected' :
                                                            ''}}>@lang('Active')</option>
                                                        <option value="0" {{$location->status == 0 ? 'selected' :
