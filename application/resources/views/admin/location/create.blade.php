                ...
                <div class="card-body">
                    <div class="row gy">
                        ...
                        <form action="{{ route('admin.location.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <span class="badge text-dark bg-warning d-none mb-2" id="authfail">@lang('Google Maps API authentication failed! Please check your API key. Please Go to global settings and set Maps API key.')</span>
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-sm-4">
                                                    ...
                                                    <div class="thumb">
                                                        <div class="avatar-preview">
                                                            <div class="profilePicPreview"
                                                                style="background-image: url({{ getImage(getFilePath('location') . '/' . 'default.jpg'), getFileSize('location') }})">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="location" id="locationInput"
                                                            class="controls form-control" value="{{old('location')}}"  placeholder="@lang('Enter a location')"
                                                            autocomplete="off">
                                                    </div>
                                                </div>
