        ...
        <div class="row mx-0 justify-content-center">
            <div class="col-md-8 col-lg-7 col-xl-5">
                <div class="base--card custom--card">
                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            <p>@lang('Choose a password for your account. Please use a strong password and don\'t share it with anyone.')</p>
                        </div>
                        <form method="POST" action="{{ route('user.set.password.update') }}">
                            @csrf
