...
<head>
    ...
    <link rel="stylesheet" href="{{asset($activeTemplateTrue . 'css/custom.css?v=1785132927')}}">
...
<body>
    ...
    <section class="dashboard-section">
        <div class="dashboard">
            @include($activeTemplate . 'components.agency.side_nav')
            <div class="dashboard-container-wrap">
                <div class="dashboard-body">
                    <div class="container-fluid">
                        @include($activeTemplate . 'components.agency.top_header')
                        @yield('content')
                    </div>
                </div>
            </div>
